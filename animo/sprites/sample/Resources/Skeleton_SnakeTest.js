...
game.addEventListener('onload', function(e) {
	...
	var text2 = platino.createTextSprite({text:'Drag to move the snake. ', fontSize:14});
...
function createSkeletonAtPosition(posX, posY)
{
	...
	if(mySkeleton == null)
	{
        ...
        mySkeleton = animo.createSkeletonWithFile("graphics/RES_Skeleton_Snake/skeletons/Snake_SnakeSkeleton"+suffix+".json",
                                                        scene);     
...
game.addEventListener('touchmove', function(e) {
    ...
    if(mySkeleton){
        ...
        mySkeleton.setPositionForBoneNamed(e.x, y, "RootBone");        
    }
});
